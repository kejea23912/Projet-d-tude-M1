...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{length}\NormalTok{(}\FunctionTok{unique}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{adresse))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{length}\NormalTok{(}\FunctionTok{unique}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{etiquette\_dpe))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{length}\NormalTok{(}\FunctionTok{unique}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{numero\_dpe))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{df2 }\OtherTok{\textless{}{-}}\NormalTok{df }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{rename}\NormalTok{(}\AttributeTok{Conso\_totale =}\NormalTok{ Consommation.annuelle.totale.de.l.adresse..MWh., }\AttributeTok{Conso\_Moy\_log =}\NormalTok{ Consommation.annuelle.moyenne.par.logement.de.l.adresse..MWh.,}\AttributeTok{Conso\_com =}\NormalTok{ Consommation.annuelle.moyenne.de.la.commune..MWh. ) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{select}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{adresse, }\SpecialCharTok{{-}}\NormalTok{numero\_dpe)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{qualitative\_cols}\OtherTok{\textless{}{-}}\FunctionTok{c}\NormalTok{(}\StringTok{"etiquette\_dpe"}\NormalTok{,}\StringTok{"etiquette\_ges"}\NormalTok{)}
\NormalTok{df2[qualitative\_cols]}\OtherTok{\textless{}{-}}\FunctionTok{lapply}\NormalTok{(df2[qualitative\_cols], as.factor)}
\NormalTok{quantitative\_cols}\OtherTok{\textless{}{-}}\FunctionTok{c}\NormalTok{(}\StringTok{"Conso\_totale"}\NormalTok{,}\StringTok{"Conso\_Moy\_log"}\NormalTok{,}\StringTok{"Conso\_com"}\NormalTok{,}\StringTok{"annee\_construction"}\NormalTok{,}\StringTok{"surface\_habitable\_logement"}\NormalTok{,}\StringTok{"conso\_5.usages\_ef"}\NormalTok{,}\StringTok{"emission\_ges\_5\_usages"}\NormalTok{,}\StringTok{"cout\_total\_5\_usages"}\NormalTok{,}\StringTok{"nombre\_appartement"}\NormalTok{)}
\NormalTok{df2[quantitative\_cols] }\OtherTok{\textless{}{-}} \FunctionTok{lapply}\NormalTok{(df2[quantitative\_cols], }\ControlFlowTok{function}\NormalTok{(x) \{}
  \FunctionTok{cut}\NormalTok{(x,}
      \AttributeTok{breaks =} \FunctionTok{unique}\NormalTok{(}\FunctionTok{quantile}\NormalTok{(x, }\AttributeTok{probs =} \FunctionTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, }\FloatTok{0.25}\NormalTok{), }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{)),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{quali.sup }\OtherTok{=} \FunctionTok{c}\NormalTok{(}\DecValTok{4}\NormalTok{,}\DecValTok{5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
\end{frame}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ACM}\OtherTok{\textless{}{-}}\FunctionTok{MCA}\NormalTok{(df2, }\AttributeTok{quali.sup =}\NormalTok{ quali.sup, }\AttributeTok{graph =}\NormalTok{ F, }\AttributeTok{ncp =} \ConstantTok{Inf}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ACM}\SpecialCharTok{$}\NormalTok{eig}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{fviz\_eig}\NormalTok{(ACM)}
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{Presentation_files/figure-beamer/unnamed-chunk-9-1.pdf}}
\end{block}
\end{frame}
...
\begin{frame}[fragile]{Mise en Oeuvre de la clasification non supervisée
à partir de l'ACM}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{res.MCA}\OtherTok{\textless{}{-}}\FunctionTok{MCA}\NormalTok{(df2,}\AttributeTok{ncp=}\ConstantTok{Inf}\NormalTok{ ,}\AttributeTok{graph=}\ConstantTok{FALSE}\NormalTok{)}
\NormalTok{res.HCPC}\OtherTok{\textless{}{-}}\FunctionTok{HCPC}\NormalTok{(res.MCA,}\AttributeTok{nb.clust=}\DecValTok{4}\NormalTok{,}\AttributeTok{consol=}\ConstantTok{FALSE}\NormalTok{,}\AttributeTok{graph=}\ConstantTok{FALSE}\NormalTok{)}
\FunctionTok{plot.HCPC}\NormalTok{(res.HCPC,}\AttributeTok{choice=}\StringTok{\textquotesingle{}tree\textquotesingle{}}\NormalTok{,}\AttributeTok{title=}\StringTok{\textquotesingle{}Arbre hiérarchique\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot.HCPC}\NormalTok{(res.HCPC,}\AttributeTok{choice=}\StringTok{\textquotesingle{}map\textquotesingle{}}\NormalTok{,}\AttributeTok{draw.tree=}\ConstantTok{FALSE}\NormalTok{,}\AttributeTok{title=}\StringTok{\textquotesingle{}Plan factoriel\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{Presentation_files/figure-beamer/unnamed-chunk-10-2.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{fviz\_cluster}\NormalTok{(res.HCPC, }\AttributeTok{geom =} \StringTok{"point"}\NormalTok{, }\AttributeTok{ellipse =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{Presentation_files/figure-beamer/unnamed-chunk-11-1.pdf}}
\end{frame}
